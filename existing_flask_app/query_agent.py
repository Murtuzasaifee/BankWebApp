...
class AgentPlatformClient:
    ...
    def __init__(
        ...
        Args:
            base_url: Base URL for the platform API (defaults to config)
            auth_base: Base URL for authentication (defaults to config)
            tenant: Tenant identifier (defaults to config)
            api_key: API key for authentication (defaults to config)
            workspace_id: Workspace identifier (defaults to config)
        ...
        self.auth_base = auth_base or config['auth_base']
